...
<link  rel="stylesheet" href="cssi/bootstrap.min.css"/>
 <link  rel="stylesheet" href="cssi/bootstrap-theme.min.css"/>    
 <link rel="stylesheet" href="cssi/main.css">
 <link  rel="stylesheet" href="cssi/font.css">
...
<div class="modal fade" id="signup">
  <div class="modal-dialog">
    <div class="modal-content title1">
      ...
      <div class="modal-body">
       <form class="form-horizontal" name="form" onSubmit="return validateForm()" action="update.php" method="POST">
<fieldset>
...
<div class="form-group">
  <label class="col-md-3 control-label" for=""></label>
  <div class="col-md-6"> 
    <button type="submit" class="sub btn btn-primary">Submit Feedback</button>
  </div>
</div>
</fieldset>
</form>
